...
//             {
//                 case UserChoice.ShowAllBackup:
//                     BackupsViewModel.DisplayAllBackup();
//                     break;
//                 case UserChoice.CreateBackup:
//                 {
//                     var (name, sourcePath, targetPath, backupType) = AskForCreatingBackup();
//                     BackupsViewModel.CreateBackup(name, sourcePath, targetPath, backupType);
//                     break;
//                 }
//                 case UserChoice.DeleteBackup:
//                 {
//                     var name = AskForDeletingBackup();
//                     BackupsViewModel.DeleteBackup(name);
//                     break;
//                 }
//                 case UserChoice.RenameBackup:
//                 {
//                     var (name, newName) = AskForRenamingBackup();
//                     BackupsViewModel.RenameBackup(name, newName);
//                     break;
//                 }
//                 case UserChoice.ExecuteAllBackup:
//                 {
//                     BackupsViewModel.ExecAllBackup();
//                     break;
//                 }
...
//                     break;
//                 }
//                 case UserChoice.ExecuteBackup:
//                 {
//                     var name = AskForNametoExecute();
//                     BackupsViewModel.ExecuteBackup(name);
//                     break;
//                 }
...
//     private static (string, string) AskForRenamingBackup()
//     {
...
//     private static string AskForDeletingBackup()
//     {
...
//     private static (string, string, string, SaveType) AskForCreatingBackup()
//     {
